...
public class QTabView extends TabView {
    ...
    public ITabView.TabIcon.Builder builder_tab;
    public ITabView.TabTitle.Builder builder_title;
    public ITabView.TabBadge.Builder builder_bad;
    ...
    public QTabView(Context context) {
        ...
        builder_tab = new ITabView.TabIcon.Builder();
        mTabIcon = builder_tab.build();

        builder_title = new ITabView.TabTitle.Builder();
        mTabTitle = builder_title.build();

        builder_bad = new ITabView.TabBadge.Builder();
        mTabBadge = builder_bad.build();
...
//        mTabBadge = new TabBadge.Builder().build();
    ...
    private void initTitleView() {
        ...
        mTitle.setTextColor(isChecked() ? green : black);

        // mTitle.setTextColor(Color.RED);
        Log.e("build", "initTitleView.Size: " + mTabTitle.getTitleTextSize());
    ...
    @Override
    public QTabView setIcon(ITabView.TabIcon icon) {
        if (icon != null) {
            mTabIcon = icon;
        }
        initIconView();
    ...
    @Override
    public QTabView setTitle(ITabView.TabTitle title) {
        if (title != null) {
            mTabTitle = title;
        }
        initTitleView();
...
//        mTitle.setTextColor(Color.BLACK);
        //  mTitle.setTextColor(isChecked() ? Color.GREEN : Color.BLACK);
        mTitle.setTextColor(isChecked() ? green : black);
        initIconView();
    }
