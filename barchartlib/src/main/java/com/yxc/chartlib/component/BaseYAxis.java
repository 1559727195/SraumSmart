...
public class BaseYAxis extends AxisBase {
    ...
    public BaseYAxis(BaseChartAttrs barChartAttrs) {
        ...
        setLabelCount(mChartAttrs.yAxisLabelSize,"1");
    ...
    //获取Y轴刻度值
    public static BaseYAxis getYAxis(BaseChartAttrs attrs, float max, String step) {
    ...
    public BaseYAxis resetYAxis(BaseYAxis axis, float max, String step) {
        float axisMaximum;
        int layoutCount;
        if (max > 50000) {
            axisMaximum = 8000;
