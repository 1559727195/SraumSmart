...
public class ChartAttrsUtil {
    ...
    public static BarChartAttrs getBarChartRecyclerAttrs(Context context, AttributeSet attributeSet) {
        ...
        //barChartValueXColor
        attrs.barChartValueXColor = ta.getColor(R.styleable.BarChartRecyclerView_barChartValueXColor, ColorUtil.getResourcesColor(context, R.color.col_orange));
        ...
        attrs.xAxisTxtColor = ta.getColor(R.styleable.BarChartRecyclerView_xAxisTxtColor, ColorUtil.getResourcesColor(context, R.color.col_orange));
