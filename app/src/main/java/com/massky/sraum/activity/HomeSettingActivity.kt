 ...
 */
class HomeSettingActivity : BaseActivity(), XListView.IXListViewListener {
    ...
    private fun sraum_getAllArea() {
        ...
        mapdevice["token"] = TokenUtil.getToken(this@HomeSettingActivity)
        ...
        MyOkHttp.postMapString(ApiHelper.sraum_getAllArea
            ...
            sraum_getAllArea()
        }, this@HomeSettingActivity, dialogUtil) {
...
//                            }
                    ...
                    homesettingadapter = MyAreaListAdapter(this@HomeSettingActivity, areaList, "roomManager")
    ...
    private fun sraum_getRoomsInfo(areaNumber: String, authType: String) {
        ...
        MyOkHttp.postMapString(ApiHelper.sraum_getRoomsInfo
            ...
            override fun wrongBoxnumber() {
                ToastUtil.showToast(this@HomeSettingActivity, """
     areaNumber
     不存在
     """.trimIndent())
            }
    ...
    private fun display_room_list() {
        manageroomadapter = ManagerRoomAdapter(this@HomeSettingActivity, roomList)
    ...
    override fun onClick(v: View) {
        when (v.id) {
            R.id.back -> finish()
            R.id.btn_cancel_wangguan, R.id.add_room -> startActivity(Intent(this@HomeSettingActivity, AddAreaActivity::class.java))
        }
    }
