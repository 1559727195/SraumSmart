 ...
 */
class FamilySettingActivity : BaseActivity(), XListView.IXListViewListener {
    ...
    private fun sraum_getAllArea() {
        ...
        mapdevice["token"] = TokenUtil.getToken(this@FamilySettingActivity)
        ...
        MyOkHttp.postMapString(ApiHelper.sraum_getAllArea
            ...
            sraum_getAllArea()
        }, this@FamilySettingActivity, dialogUtil) {
...
//                            }
                    ...
                    homesettingadapter = MyAreaListAdapter(this@FamilySettingActivity, areaList, "familyManager")
    ...
    private fun sraum_getRoomsInfo(areaNumber: String, authType: String) {
        ...
        MyOkHttp.postMapString(ApiHelper.sraum_getRoomsInfo
            ...
            override fun wrongBoxnumber() {
                ToastUtil.showToast(this@FamilySettingActivity, """
     areaNumber
     不存在
     """.trimIndent())
            }
    ...
    private fun display_room_list() {
        manageroomadapter = ManagerRoomAdapter(this@FamilySettingActivity, roomList)
    ...
    override fun onClick(v: View) {
        when (v.id) {
            R.id.back -> finish()
            R.id.btn_cancel_wangguan, R.id.add_room -> startActivity(Intent(this@FamilySettingActivity, AddAreaActivity::class.java))
        }
    }
