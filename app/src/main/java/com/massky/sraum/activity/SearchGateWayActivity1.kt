...
import com.massky.sraum.activity.SearchGateWayActivity1
import com.massky.sraum.adapter.ShowUdpServerAdapter
import com.massky.sraum.base.BaseActivity
import com.massky.sraum.fragment.SearchDialogFragment
import com.massky.sraum.fragment.SearchDialogFragment.Companion.newInstance
 ...
 */
class SearchGateWayActivity1 : BaseActivity() {
    @JvmField
    ...
    private var tiaozhuan_bool //跳转判断
            = false
    ...
    override fun onView() {
        ...
        showUdpServerAdapter = ShowUdpServerAdapter(this@SearchGateWayActivity1, list)
    ...
    private fun initDialog() {
        ...
        newFragment = newInstance(this@SearchGateWayActivity1, "", "", object : SearchDialogFragment.DialogClickListener {
            override fun dialogDismiss() { //重新进行搜索
                init_udp_search()
            }
        }) //初始化快配和搜索设备dialogFragment
        sendParamsInterfacer = newFragment as SendParamsInterfacer?
    }
...
//            SearchGateWayActivity.this.finish();
            val intent = Intent(this@SearchGateWayActivity1, EditGateWayResultActivity::class.java)
...
//            titlecen_id.setText("");
    ...
    private fun end_activity() {
        ...
        this@SearchGateWayActivity1.setResult(Activity.RESULT_OK, intent)
        finish()
    }
