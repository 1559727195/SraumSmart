...
public class KeyPowerItemSecondAdapter extends android.widget.BaseAdapter {
    ...
    public KeyPowerItemSecondAdapter(Context context, List<Map> listint) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.key_power_item, null);
