...
public class ConfigApDialogFragment extends DialogFragment implements View.OnClickListener,
        ConnApWifiActivity.ConnWifiInterfacer {
...
//    }
    ...
    public ConfigApDialogFragment() {

    }

    public static ConfigApDialogFragment newInstance(Context context1, String title, String message, DialogClickListener listener) {
        ConfigApDialogFragment frag = new ConfigApDialogFragment();
        Bundle b = new Bundle();
