...
public class ConfigApModeDialogFragment extends DialogFragment implements View.OnClickListener,
        ConnApModeWifiActivity.ConnWifiInterfacer {
...
//    }
    ...
    public static ConfigApModeDialogFragment newInstance(Context context1, String title, String message, DialogClickListener listener) {
        ConfigApModeDialogFragment frag = new ConfigApModeDialogFragment();
        Bundle b = new Bundle();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.config_ap_mode_dialog_fragment, null, false);
        //添加这一行
