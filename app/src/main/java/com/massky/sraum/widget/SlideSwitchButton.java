...
//        mPaint.setAlpha(mAlpha);//mPaint,mAlpha = 0时为完全透明
        ...
        toDestAnim.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (toRight) {
                    isOpen = true;
                    if (listener != null) {
                        listener.openState(true, SlideSwitchButton.this,false);
                    }
                    mStartValue = maxValue;
                } else {
                    isOpen = false;
                    if (listener != null) {
                        listener.openState(false, SlideSwitchButton.this,false);
                    }
    ...
    public void changeOpenState(boolean isOpen) {
        ...
        if (listener != null) {
            if (isOpen) {
                listener.openState(true, SlideSwitchButton.this,true);
            } else {
                listener.openState(false, SlideSwitchButton.this,true);
            }
        }
    }
    ...
    public interface SlideListener {
        void openState(boolean isOpen, View view, boolean from);
    }
