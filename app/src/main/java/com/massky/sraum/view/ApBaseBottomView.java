...
class ApBaseBottomView {
    ...
    public ApBaseBottomView(Context context) {
...
//            });
            ...
            //将控件添加到decorView中
            rootView = (ViewGroup) layoutInflater.inflate(R.layout.act_btn_view, decorView, false);
            ...
            //拿到布局参数
            FrameLayout.LayoutParams l = (FrameLayout.LayoutParams) contentContainer.getLayoutParams();
            l.height = getScreenHeight(context) / 2;
        }
        ...
        decorView.post(new Runnable() {
            ...
            public void run() {
                ...
                if (onDismissListener != null) {
                    onDismissListener.onDismiss(ApBaseBottomView.this);
                }
            }
        });
    ...
    public ApBaseBottomView setOnDismissListener(OnDismissListener onDismissListener) {
