...
public class NestedSampleRadioGroup extends LinearLayout {
    ...
    public NestedSampleRadioGroup(Context context) {
        super(context);
    ...
    public NestedSampleRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    @Override
    public void addView(View child, int index, ViewGroup.LayoutParams params) {//jkkhg
        setViewState(child);
...
//        }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(NestedSampleRadioGroup.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(NestedSampleRadioGroup.class.getName());
    }
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        public void onCheckedChanged(NestedSampleRadioGroup group, int checkedId);
        void onCheckedByItemSelf(int checkedId);
    }
    ...
    private class CheckedStateTracker implements BaseRadioLayout.OnCheckedChangeListener {
        ...
        @Override
        public void onCheckedByItemSelf() {
            Log.e("TAG", "toggle: "  + mCheckedId);
            if (mOnCheckedChangeListener != null) {
                mOnCheckedChangeListener.onCheckedByItemSelf(mCheckedId);
            }
        }
    }
