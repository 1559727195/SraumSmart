...
import com.ezuikit.open.DoublePlayYingShiActivity;
import com.ezuikit.open.MainYingShiActivity;
import com.ezuikit.open.PlayYingShiActivity;
    ...
    public void handleDecode(String resultString, Bitmap barcode) {
        ...
        try{
            ...
            if (!TextUtils.isEmpty(appKey)
                ...
                intent.putExtra(PlayYingShiActivity.APPKEY,appKey);
                intent.putExtra(PlayYingShiActivity.AccessToekn,accessToken);
                intent.putExtra(PlayYingShiActivity.Global_AreanDomain,apiUrl);
                intent.putExtra(DoublePlayYingShiActivity.TYPE,type);
                intent.putExtra(PlayYingShiActivity.PLAY_URL,urlArray.toString());
                setResult(MainYingShiActivity.RESULT_OK, intent);
                finish();
            }
        }catch (Exception e){
            e.printStackTrace();
