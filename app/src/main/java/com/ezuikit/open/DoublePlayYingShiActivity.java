...
public class DoublePlayYingShiActivity extends Activity implements View.OnClickListener{
    ...
    public static void startPlayActivity(Context context,String appkey,String accesstoken,String url1,String url2){
        Intent intent = new Intent(context, DoublePlayYingShiActivity.class);
        ...
        mEZUIPlayer1.setCallBack(new EZUIPlayer.EZUIPlayerCallBack() {
            ...
            public void onPlayFail(EZUIError ezuiError) {
                ...
                if (ezuiError.getErrorString().equals(EZUIError.UE_ERROR_INNER_VERIFYCODE_ERROR)){
                    ...
                    // TODO: 2017/5/12
                    //未发现录像文件
                    Toast.makeText(DoublePlayYingShiActivity.this,getString(R.string.string_not_found_recordfile),Toast.LENGTH_LONG).show();
                }
            }
            @Override
