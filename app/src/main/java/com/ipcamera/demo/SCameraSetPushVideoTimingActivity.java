...
//        key = it.getIntExtra("key", 0);
        ...
        map_item_record = (Map) it.getSerializableExtra("map_item_record");
        if (map_item_record != null) {
            startTime = (String) map_item_record.get("startTime");
            endTime = (String) map_item_record.get("endTime");
        }
...
//				timing_timePicker1.getCurrentMinute());
                ...
                try {
                    timing_timePicker1.setCurrentHour(Integer.parseInt(start_str[0]));
                    timing_timePicker1.setCurrentMinute(Integer.parseInt(start_str[1]));

                    timing_timePicker2.setCurrentHour(Integer.parseInt(end_str[0]));
                    timing_timePicker2.setCurrentMinute(Integer.parseInt(end_str[1]));
...
//            getWeekPlan(value);
    ...
    private void get_weeks_plan_two() {
        String monday = (String) map_item_record.get("monday");
        String tuesday = (String) map_item_record.get("tuesday");
        String wednesday = (String) map_item_record.get("wednesday");
        String thursday = (String) map_item_record.get("thursday");
        String friday = (String) map_item_record.get("friday");
        String saturday = (String) map_item_record.get("saturday");
        String sunday = (String) map_item_record.get("sunday");
        switch (sunday) {
            case "1":
...
//        String areaNumber = (String) SharedPreferencesUtil.getData(SCameraSetPushVideoTimingActivity.this, "areaNumber", "");
        ...
        map_camera_time_zone.put("endTime", endTime);
        ...
        map_camera_time_zone.put("sunday", "0");
        ...
        if (dateset.size() != 0) {
            ...
            while (it.hasNext()) {
                ...
                switch (weekday) {
                    case 0://周日
                        map_camera_time_zone.put("sunday", "1");
                        break;
                    case 1://周一
                        map_camera_time_zone.put("monday", "1");
                        break;
                    case 2:
                        map_camera_time_zone.put("tuesday", "1");
                        break;
                    case 3:
                        map_camera_time_zone.put("wednesday", "1");
                        break;
                    case 4:
                        map_camera_time_zone.put("thursday", "1");
                        break;
                    case 5:
                        map_camera_time_zone.put("friday", "1");
                        break;
                    case 6:
                        map_camera_time_zone.put("saturday", "1");
                        break;
                }
            }
        }
...
//                sensor_set_protection(isUse);
    ...
    private void getPlanTimerInt() {
        ...
        if (type == 1) {
            ...
            its.putExtra("map_camera_time_zone", (Serializable) map_camera_time_zone);
//			setResult(2016, its);
            setResult(2012, its);
            finish();
        } else {
...
//			setResult(2015, its);
    ...
    public void showToast(String t) {
        Toast.makeText(SCameraSetPushVideoTimingActivity.this, t, Toast.LENGTH_SHORT).show();
    }
