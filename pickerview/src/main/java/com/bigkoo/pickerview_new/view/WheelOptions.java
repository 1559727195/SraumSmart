...
import com.bigkoo.pickerview_new.adapter.ArrayWheelAdapter;
import com.bigkoo.pickerview_new.lib.WheelView;
import com.bigkoo.pickerview_new.listener.OnItemSelectedListener;
...
public class WheelOptions<T> {
	...
	public void setPicker(ArrayList<T> options1Items,
		...
		if (this.mOptions2Items == null)
			len = 12;
		// 选项1
		wv_option1 = (WheelView) view.findViewById(com.bigkoo.pickerview_new.R.id.options1);
		wv_option1.setAdapter(new ArrayWheelAdapter(mOptions1Items, len));// 设置显示数据
		wv_option1.setCurrentItem(0);// 初始化时显示的数据
		// 选项2
		wv_option2 = (WheelView) view.findViewById(com.bigkoo.pickerview_new.R.id.options2);
		...
		// 选项3
		wv_option3 = (WheelView) view.findViewById(com.bigkoo.pickerview_new.R.id.options3);
