...
import com.bigkoo.pickerview_new.view.BasePickerView;
import com.bigkoo.pickerview_new.view.WheelOptions;
...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    public OptionsPickerView(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(R.layout.pickerview_options_new, contentContainer);
        // -----确定和取消按钮
