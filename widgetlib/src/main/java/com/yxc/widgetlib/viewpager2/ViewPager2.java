package com.yxc.widgetlib.viewpager2;
...
public final class ViewPager2 extends ViewGroup {
    ...
    private void setOrientation(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, androidx.viewpager2.R.styleable.ViewPager2);
        try {
            setOrientation(
                    a.getInt(androidx.viewpager2.R.styleable.ViewPager2_android_orientation, ORIENTATION_HORIZONTAL));
        } finally {
            a.recycle();
        }
    }
     ...
     *
     * <p>If you're planning to use Fragments as pages,
